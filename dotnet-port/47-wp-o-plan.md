...
**状態: ドラフト — PO 未合意。** 本書は PO レビューのたたき台であり、確定した計画ではない。
合意までは `00-PLAN.md` / `36-prerelease-quality-plan.md` へのリンク追記・WP 表更新はしない。
合意後に反映する。
